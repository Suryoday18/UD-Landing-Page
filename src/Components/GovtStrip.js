...
const GovtStrip = () => {
  ...
  return (
    <Box sx={{ height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', bgcolor: '#f0f0f0' }}>
       <img src="http://www.ud.hp.gov.in/sites/default/files/logo.png" alt="image1" style={{ width: '50px', height: '50px', marginLeft: '-250px', marginRight: '30px' }} />
        ...
        <Typography variant="h4" sx={{ marginTop: '10px', fontSize: '14px', fontStyle: "italic", width: '450px'}}>Govt of Himanchal Pradesh, India</Typography>
        <Typography variant="h4" className={classes.line1} sx={{marginTop: '120px', fontWeight: 'bold', fontSize: '12px', fontStyle: "italic", width: '450px'}}>e-Avedan Online Building Planning Permission in Urban local Bodies</Typography>
        </Box>
