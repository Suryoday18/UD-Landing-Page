...
const FooterOne = () => {
  return (
    <Box sx={{ height: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', bgcolor: '#f0f0f0', boxShadow: 'rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;' }}>
