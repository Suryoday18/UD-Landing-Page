...
const Checklist = () => {
  ...
  return (
    <div className={classes.container}>
      ...
      {/* <Typography variant="body1" className={classes.paragraph}>
      <span style={{margin: '3px'}}><AiOutlineDoubleRight /></span> Procedure, Checklist For Obtaning Noc After ...     
      </Typography>
      <Typography variant="body1" className={classes.paragraph}>
      <span style={{margin: '3px'}}><AiOutlineDoubleRight /></span> Inspection Procedure & Checklist For ...
      </Typography> */}
